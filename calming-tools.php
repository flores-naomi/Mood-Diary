...
<body>
  ...
  <div class="modal" id="modal-sounds">
    <div class="dialog wide">
      ...
      <div class="list-card"><div class="text"><div class="title">Rain</div></div><button class="sound-play">▶</button></div>
      <div class="list-card"><div class="text"><div class="title">Ocean Waves</div></div><button class="sound-play">▶</button></div>
      <div class="list-card"><div class="text"><div class="title">Forest</div></div><button class="sound-play">▶</button></div>
      <div class="list-card"><div class="text"><div class="title">Piano</div></div><button class="sound-play">▶</button></div>
    </div>
  </div>
