...
<body>
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a class="nav-item active" href="daily-log.php"><span class="nav-icon">📖</span>Daily Log</a>
      ...
      <section class="card card-pad">
        ...
        <div class="device-controls">
          <div class="device-item">
            <div class="device-status on" id="cameraStatus"></div>
            <span class="device-label">Camera</span>
            <div class="device-toggle on" id="cameraToggle">
        ...
        <div style="display:flex;gap:10px;margin-top:10px">
          <button id="startDetect" class="btn primary" style="padding:8px 12px">▶️ Start Detection</button>
  ...
  <script>
    ...
    document.getElementById('micToggle').addEventListener('click', () => {
      deviceState.mic = !deviceState.mic;
    ...
    // wire up unified Start Detection button (starts/stops camera+mic together)
    document.getElementById('startDetect')?.addEventListener('click', async () => {
